...
public class Server {
	...
	public static void help() {
		System.out.println("Filter.Server PORT\n");
    ...
    public static void main(String[] args) throws IOException {
        ...
        server.createContext("/process", new ProcessHandler(null));
    ...
    static class ProcessHandler extends CoreHandler {
		public ProcessHandler(String base_log_path) {
			super(base_log_path);
		}
		...
		public String getResult(JSONObject jsonData, String jsonStr) throws JSONException, IOException {
			...
			if(action.equalsIgnoreCase("addcolumns")) {
				...
				List<String> columns=in.getColumns();
				if(columns.size()>0) {
					for(int i=0;i<newColumnsData.length;i++)columns.add(newColumnsData[i]);
				}
				
				CONLLUPWriter out=new CONLLUPWriter(Paths.get(output),
